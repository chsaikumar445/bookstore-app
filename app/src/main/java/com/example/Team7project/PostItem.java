...
public class PostItem extends AppCompatActivity {
    ...
    EditText name,price,description,genere,mobile,storeaddress;
    ImageView item_pic;
    ...
    public void uploadPic(String ItemName,String descriptionStr, String priceStr, String genere, String mobileNo, String address){
        if(uriImage != null){
            Random r = new Random();
...
//                            Log.i("url img",image_url[0]);
                            ReadWriteItemDetails itemDetailsObject = new ReadWriteItemDetails(ItemName, descriptionStr, priceStr, image_url[0],genere,mobileNo,address);
...
//                    String image_url=taskSnapshot.getMetadata().getReference().getDownloadUrl().toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storeaddress=findViewById(R.id.store_adddress);
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    uploadPic(ItemName,descriptionStr,priceStr,generestr,mobileNumber,address);
                }
                catch (Exception e){
